...
Summary(pl):	S³ownik pend¿abski dla aspella
Name:		aspell-pa
Version:	0.01
%define	subv	1
Release:	1
...
Source0:	ftp://ftp.gnu.org/gnu/aspell/dict/pa/aspell6-pa-%{version}-%{subv}.tar.bz2
...
%description -l pl
S³ownik pend¿abski (lista s³ów) dla aspella.
